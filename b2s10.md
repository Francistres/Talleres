...
```Scala
package ClasesB2.semana10.Taller2
import rescala.default.*

object SumaReactiva extends App {
  val calificaciones: Var[List[Int]] = Var(List(10))

  val sumaCalificaciones: Signal[Int] = Signal { calificaciones.value.sum }

  val observer = sumaCalificaciones.changed.observe { sumaActual =>
...
```
### Salida del Codigo
<img width="814" height="759" alt="image" src="https://github.com/user-attachments/assets/c123fd0c-4694-42bc-9523-e3cac1adeede" />
...
object CalculoEnergiaCinetica extends App{
  ...
  println("Énergia Cinética:" + energiaCinetica.now)

  val observer = energiaCinetica.changed.observe { energiaC =>
    println(s"Énergia Cinética: $energiaC")
    if(energiaC > 1000000)
...
<img width="931" height="909" alt="image" src="https://github.com/user-attachments/assets/adcdfb3b-9d5f-45de-a53e-1aaa77bd4c76" />
