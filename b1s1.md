...
**Respuesta:**
Despues de comparar las sintaxis de cada codigo, llegue a la conclusion que la sintaxis mas facil de entender es la de Scala.
...
```
**Transformacion codigo java a scala**
